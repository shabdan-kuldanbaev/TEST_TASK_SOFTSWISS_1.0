...
export const Basket = (props) => {
	...
	return (
		<button
			...
			className={`basket-button ${props.className}`}
			{...props}
		>
			{/** biome-ignore lint/a11y/noSvgWithoutTitle: The SVG is purely decorative and its meaning is conveyed by the surrounding context. */}
			<svg
			...
			>
				<path
					...
					fill={hovered ? `url(#${gradientId})` : "white"}
				/>
				<defs>
					<linearGradient
						id={gradientId}
